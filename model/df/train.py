...
print(path)
import sys
sys.path.insert(0, "/home/test/DeepFilterNet_whisper/DeepFilterNet_whisper/DeepFilterNet/DeepFilterNet")
...
def main():
    ...
    print(p.fft_size, p.hop_size, p.nb_erb, p.min_nb_freqs)
